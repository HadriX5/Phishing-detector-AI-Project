...
def create_massive_rigged_data():
    # ESCALA REAL: 200.000 files
    n_rows = 200000 
    
    print(f"🏗️  Generant estructura per a {n_rows} files...")
    ...
    print("🛡️  2. Creant exèrcit de CLONS LEGÍTIMS (40%)...")
    ...
    print(f"✅ Dataset MASSIU creat a: {output_path}")
    print(f"📊 Dimensions: {df.shape}")

if __name__ == "__main__":
    create_massive_rigged_data()